...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Truong.flf ]; then
	echo -e "\e[1;34m[*] \033[32mTruong.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/TruongPixel/Truong/master/Truong.flf &> /dev/null;
sleep 3
cp Truong.flf $PREFIX/share/figlet/Truong.flf;
...
clear;
echo -e "\033[31m$(figlet -f Truong "TruongPixel")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Truong : (\e[33m13.10.2008\e[32m)
